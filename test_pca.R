...
sigma_c<-(1/n)^2*(1/(2*p*(1-p))) #estimation of sigma^2_c

A_i<-rnorm(1,0,1)
D_i<-rnorm(1,1/sqrt(2)*sigma_c) #normal approxiamtion of square root of C_i
...
plot(N, dcauchy(N, location = 0, scale = 1), type="l",  lwd=2,
